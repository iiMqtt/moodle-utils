...
2. **Close Mobius launch tabs** — conceals the redundant Moodle LTI handoff
   immediately, returns focus to the originating Moodle tab, then closes the
   hidden launch tab 1.2 seconds after Mobius opens.
